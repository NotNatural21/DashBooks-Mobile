<template>
	...
	<div class="form_container" v-if="invoiceForm == `createUser`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createUser">Create User</div>
	...
	<div class="form_container" v-if="invoiceForm == `editUser`">
		<div class="form" id="editUserForm">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editUser">Save User</div>
                <div class="button_item glossy" style="background-color: red;" @click="deleteUser">Delete</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="invoiceForm == `createClient`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createClient">Create Client</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="invoiceForm == `editClient`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editClient">Save Client</div>
                <div class="button_item glossy" style="background-color: red;" @click="deleteClient">Delete</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
