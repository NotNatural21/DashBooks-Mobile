<template>
	...
	<div class="form_container" v-if="projectForm == `createProject`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createProject">Create Project</div>
	...
	<div class="form_container" v-if="projectForm == `createColour`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createColour">Create Colour</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="projectForm == `editColour`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editColour">Save Colour</div>
                <div class="button_item glossy" style="background-color: red;" @click="deleteColour">Delete</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
