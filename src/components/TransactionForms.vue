<template>
	...
	<div class="form_container" v-if="transform == `createTransaction`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createTransaction">Create Transaction</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="cancel">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="transform == `editTransaction`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editTransaction">Save Transaction</div>
	...
	<div class="form_container" v-if="transform == `addSaved`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="addSaved">Add Saved Transaction</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="transform == `createSaved`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createSaved">Create Saved Transaction</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="transform == `editSaved`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editSaved">Save Transaction</div>
                <div class="button_item glossy" style="background-color: red;" @click="deleteSaved">Delete</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="transform == `createAsset`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="createAsset">Create Asset</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="form_container" v-if="transform == `editAsset`">
		<div class="form">
			...
			<fieldset>
                <div class="button_item glossy" style="background-color: var(--primary);" @click="editAsset">Save Asset</div>
                <div class="button_item glossy" style="background-color: red;" @click="deleteAsset">Delete</div>
                <div class="button_item glossy" style="background-color: var(--secondary);" @click="this.$emit('cancelled', '')">Cancel</div>
			</fieldset>
		</div>
	</div>
